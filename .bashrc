...
# Path to cargo utilities & to scripts
PATH="$HOME/.cargo/bin${PATH:+:${PATH}}"
PATH="$HOME/scripts${PATH:+:${PATH}}"
# Automaticlly change dir
shopt -s autocd
...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias clear_history='> ~/.bash_history && history -c && x-terminal-emulator && exit'
    ...
    alias update_bashrc='rm ~/.bashrc && cd ~/ && wget https://raw.githubusercontent.com/bobby-boy49/My-bashrc/main/.bashrc && x-terminal-emulator && exit'
